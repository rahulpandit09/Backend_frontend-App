...
const AdminDashboard: React.FC = () => {
  ...
  const fetchData = async () => {
    try {
      const summaryRes = await fetch("http://localhost:8000/admin/dashboard/summary");
      const revenueRes = await fetch("http://localhost:8000/admin/dashboard/monthly-revenue");
      const growthRes = await fetch("http://localhost:8000/admin/dashboard/student-growth");
